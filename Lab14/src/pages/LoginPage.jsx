...
function LoginPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        window.alert("El usuario o contraseño no es correcto")
    }
}
    return (
                                ...
                                <form onSubmit={handleSubmit} autoComplete="off">
                                    <div className="mb-3">
                                        ...
                                        <input id="username" type="text"
                                            className="form-control" name="email" required autoFocus onChange={onChangeUserName} />
                                    </div>
                                    <div className="mb-3">
                                        ...
                                        <input id="password" type="password"
                                            className="form-control" name="password" required onChange={onChangePassword} />
                                    </div>
                                    <div className="d-flex align-items-center">
                                        <div className="form-check">
                                            ...
                                            <label htmlFor="remember"
                                                className="form-check-label">Recordarme</label>
                                        </div>
